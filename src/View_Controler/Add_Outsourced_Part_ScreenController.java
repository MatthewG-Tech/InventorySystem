 ...
 */
public class Add_Outsourced_Part_ScreenController implements Initializable {
    ...
    @FXML
    private TextField addPartCompanyField;
    @FXML
    ...
    private void saveButtonAction(ActionEvent event) throws IOException{
        ...
        if(addPartNameField.getText().length() != 0 && addPartPriceField.getText().length() != 0 && addPartMinField.getText().length() != 0 && addPartMaxField.getText().length() != 0 && addPartCompanyField.getText().length() != 0 && validInput()){
            ...
            String companyNumber = addPartCompanyField.getText();
            if(min>max){
                ...
                Part temp = new Outsourced_Part( id, name,  price,  stock,  min,  max,  companyNumber);
    ...
    private boolean validInput(){
        if(isStringDouble(addPartPriceField.getText()) && isStringInt(addPartMinField.getText()) && isStringInt(addPartMaxField.getText()) && (addPartInventoryField.getText().length() != 0 || isStringInt(addPartInventoryField.getText()))){
            return true;
        }
        return false;
    }
